...
export default function VoiceInput({ onTranscript, onError }: VoiceInputProps) {
  ...
  return (
    <button
      ...
      className={`p-2 rounded-lg transition-all duration-200 ease-out hover:scale-110 active:scale-95 ${isListening
          ? 'bg-red-500 text-white hover:bg-red-600 shadow-elev-2 hover:shadow-elev-3 animate-pulse-soft'
          : 'btn-ghost text-neutral-600 dark:text-neutral-400'
        }`}
