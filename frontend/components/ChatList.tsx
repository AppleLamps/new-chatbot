...
export default function ChatList({
  ...
  if (isCollapsed) {
    return (
      <div className="hidden lg:flex fixed left-0 top-0 h-full w-14 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 p-2 flex-col items-center z-10 transition-all duration-300 ease-in-out">
        <button
          onClick={() => onToggleCollapse(false)}
          className="p-2 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-lg transition-colors duration-200"
  ...
  return (
    <div className={`fixed left-0 top-0 h-full w-64 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col z-30 transition-all duration-300 ease-in-out ${
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="lg:hidden p-1 hover:bg-gray-200 dark:hover:bg-gray-800 rounded transition-colors"
            title="Close menu"
          >
          ...
          <button
            ...
            className="hidden lg:block p-1 hover:bg-gray-200 dark:hover:bg-gray-800 rounded transition-colors"
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        {sessions.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
            ...
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">No chats yet</h3>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Start a conversation by clicking the button above</p>
            <button
              onClick={onNewChat}
          ...
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
            ...
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">No results found</h3>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">Try a different search term</p>
            <button
              onClick={() => setSearchQuery('')}
          ...
          filteredSessions.map((session) => (
            <div
              key={session.id}
              className={`relative group rounded-lg transition-all duration-200 ease-in-out ${
                session.id === currentSessionId
                  ? 'bg-brand-50 dark:bg-white/5 border border-brand-100 dark:border-white/10 shadow-sm'
                  : 'hover:bg-gray-100 dark:hover:bg-gray-800 border border-transparent hover:shadow-sm'
              }`}
            >
